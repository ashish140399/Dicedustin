...
const DiceLogo = require("../../../../../assets/images/dice-text.png");
...
export default class GameHeader extends React.Component<Props, State> {
    ...
    render() {
        ...
        const spinner = <FontAwesomeIcon color="white" icon="spinner" spin size="lg" />;
                ...
                <div className={Style.gameHeader}>
                    ...
                    {(isGameActive || placedBet) && [
                        <div key="1" className={Style.gameHeader__entry}>
                            <span className={Style.gameHeader__entryHeader} key="2" style={{color: "#FFE787", fontStyle: "normal", fontWeight: 500, fontSize: "14px", lineHeight: "17px", letterSpacing: "0.05em", textShadow: "0px 2px 0px rgba(0, 0, 0, 0.42)"}}>
                                Funds left
                            </span>
                    ...
                    {isGameCreating && <span style={{color: "white"}}>Creating Game Session... {spinner}</span>}
                    {serverInitiatedEnd && (
                        <div>
                            <span className="text-danger">
                    ...
                    {isGameEnded && (
                        <div style={{position: "absolute", top: "105px"}}>
                            <Button size="sm" color="secondary" onClick={this.onShow}>
                                <label style={{color: "#FFE787", fontSize: "1rem", fontWeight: 400, lineHeight: "1.5"}}>Start Game Session</label>
                            </Button>
                            <CreateGameModal
                                isOpen={modalIsOpen}
                            ...
                            {lastGameTransactionHash !== undefined && [
                                <a
                                    ...
                                    style={{marginLeft: "1em", color: "#FFE787"}}
                                    target="_blank"
                                    href={transactionUrl}
                                >
                                    End Transaction

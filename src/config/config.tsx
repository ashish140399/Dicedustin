...
export const MIN_GAME_SESSION_VALUE = 1e0; // Change 1e7 
export const MAX_GAME_SESSION_VALUE = 30; // Change 30e9
export const HOUSE_EDGE = 150;
export const HOUSE_EDGE_DIVISOR = 10000;

export const MIN_BET_VALUE = 1e4; // 1e4
export const MAX_BET_VALUE = 20e9; // 20e9
export const MIN_BANKROLL = 35e9; // 35e9

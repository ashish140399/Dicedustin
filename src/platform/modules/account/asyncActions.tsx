...
export function authenticate() {
    return async (dispatch: Dispatch, getState: GetState) => {
        ...
        let nonce = "";
        return axios
            .post("https://backdice.herokuapp.com/auth/authenticationNonce", {
                address: web3Account,
            })
            .then(response => {
            ...
            .then(result => {
                return axios.post("https://backdice.herokuapp.com/auth/authenticate", {
                    realm: REALM,
                    address: web3Account,
                    nonce,
                    signature: result,
...
export function register(username: string) {
    return async (dispatch: Dispatch, getState: GetState) => {
        ...
        return signTypedData(web3, web3Account, typedData)
            .then(result => {
                return axios.post("https://backdice.herokuapp.com/auth/register", {
                    realm: REALM,
                    address: web3Account,
                    username,
                    signature: result,
